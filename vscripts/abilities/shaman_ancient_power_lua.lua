function AncientPower(keys)
    ...
    local ability2_name = "healing_wave";
    local ability3_name = "ligntening_shield";
    ...
    local handle_new_ability = caster:FindAbilityByName(ability2_newname);
    ...
    local handle_new_ability = caster:FindAbilityByName(ability3_newname);
